...
def train_model(model, train_loader, args, val_loader_for_eval, epoch_start_val=0):
    ...
    for epoch in range(epoch_start_val, args.epochs):
        ...
        current_loss, current_top1_acc, current_top5_acc = test_model(model, val_loader_for_eval, f"Epoch {epoch+1} Validation") 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', default=10, type=int, # Fine-tuning usually needs fewer epochs
